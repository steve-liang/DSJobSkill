...
![](E:\Users\TradingHome\Documents\GitHub\DSJobSkill\AdvSearch.png)
...
![](E:\Users\TradingHome\Documents\GitHub\DSJobSkill\StartPage1.png)
![](E:\Users\TradingHome\Documents\GitHub\DSJobSkill\StartPage2.png)
...
# Create empty running total dataframe
...
* R outranks Python in my limited(86) sample space. More than 60% of the job postings contain R in their descriptions. It's no doubt the most wanted skill for data scientists in Chicago
...
![](E:\Users\TradingHome\Documents\GitHub\DSJobSkill\Nationwide.png)
...
![](E:\Users\TradingHome\Documents\GitHub\DSJobSkill\DataAnalystSkills.png)
...
* SQL follows at third place and 2nd place for Data Analyst jobs. We know for a fact that, SQL is a must everywhere
* SAS/Excel still display strong presense in job descriptions. For Data Analyst, Excel is almost the most wanted However; but be cautious that Data Analyst can be a title doing different job than data science. Data entry can also be titled Data Analyst. This is an overly generic title
* Compare Nationwide to Chicago's result, occurrences of R/Python drop from 60% to 30%; I will need to seek an explanation
